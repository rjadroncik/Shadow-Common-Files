...
CButtonRadio::CButtonRadio(_INOUT CWindowAbstract* pParent)
{
...
void CButtonRadio::OnWindowPaint(_IN CEventWindow& rEvent)
{
	//Prepare variables
...
void CButtonRadio::AutoRect(_OUT SCFGraphics::Rect4i& rOutRect)
{
	...
	rOutRect.iWidth  = (int)rt.Width + BTN_STYLE_CLICK_CIRCLE_SIZE + 3 + 2;
	rOutRect.iHeight = (int)rt.Height + 4;
}