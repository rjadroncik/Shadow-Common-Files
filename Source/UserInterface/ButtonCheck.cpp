...
CButtonCheck::CButtonCheck(_INOUT CWindowAbstract* pParent)
{
...
void CButtonCheck::OnWindowPaint(_IN CEventWindow& rEvent)
{
	//Prepare variables
...
void CButtonCheck::AutoRect(_OUT SCFGraphics::Rect4i& rOutRect)
{
