...
namespace SCFXML
{
	...
	public:
		...
		inline CXMLElement* ChildNamed      (_IN CString rName) _GET { return (CXMLElement*)CXMLNode::ChildNamed      (rName); }
		inline CXMLElement* ChildOrSelfNamed(_IN CString rName) _GET { return (CXMLElement*)CXMLNode::ChildOrSelfNamed(rName); }

	public:
		///////////////////////// Siblings ///////////////////////////

		inline CXMLElement* NextNamed(_IN CString rName) _GET { return (CXMLElement*)CXMLNode::NextNamed(rName); }

	public:
		///////////////////////// Descendants ///////////////////////////

		inline CXMLElement* DescendantsNamed      (_IN CString rName) _GET { return (CXMLElement*)CXMLNode::DescendantsNamed      (rName); }
		inline CXMLElement* DescendantsOrSelfNamed(_IN CString rName) _GET { return (CXMLElement*)CXMLNode::DescendantsOrSelfNamed(rName); }
