...
namespace SCFXML
{
	...
	{
	public:
		SCF::ENUM ClassKey() _GET { return ClassXMLDocumentFile; }
	...
	public:
		bool Write(_IN SCF::ENUM eEncoding = EncodingUCS2);

	public:
		bool Read (_IN _REF CFile& rFile, _IN bool bOwnFile = TRUE);
		bool Write(_IN _REF CFile& rFile, _IN SCF::ENUM eEncoding = EncodingUCS2);
	...
	public:
		...
		bool PrepareXMLDeclaration(_IN SCF::ENUM eEncoding);
