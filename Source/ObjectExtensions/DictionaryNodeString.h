...
namespace SCFPrivate
{
	...
	public:
		...
		static CDictionaryNodeString* Create          (_IN TCHAR cLetter);
	...
	public:
		inline TCHAR Letter()                  _GET { return m_cLetter; }
		inline void  Letter(_IN TCHAR cLetter) _SET { m_cLetter = cLetter; }

	public:
		inline UINT Usage() _GET { return m_uiUsage; }
