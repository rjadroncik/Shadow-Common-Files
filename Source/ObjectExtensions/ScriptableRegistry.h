...
{
	class OBJECT_EXTENSIONS_API CScriptableRegistry
	{
	public:
		//Registers a class & performs name mappings
		static void EnumerationRegister(_IN CString& rName, _IN CScriptableEnumeration& rEnumeration);
		...
		static CScriptableEnumeration* Enumeration(_IN CString& rName);

	public:
		//Registers a class & performs name mappings
		static void ClassRegister(_IN CString& rName, _IN SCF::ENUM eClassKey, _IN CScriptableClass& rClass);

		//You can get a class descriptor based on a name or class key
		static CScriptableClass* Class(_IN CString& rName);
		static CScriptableClass* Class(_IN SCF::ENUM eClassKey);
