...
namespace SCFBase
{
    ...
    class OBJECT_EXTENSIONS_API CDictionaryInt64Raw : public CObject
    {
        friend class OBJECT_EXTENSIONS_API CEnumeratorDictionaryInt64Raw;
