...
void CFloat3::Serialize(_INOUT IStreamWrite& rStream) const
{
	rStream.PutBytes(m_Value, sizeof(Float3));
}

void CFloat3::Deserialize(_INOUT IStreamRead& rStream)
{
	rStream.GetBytes(m_Value, sizeof(Float3));
}
