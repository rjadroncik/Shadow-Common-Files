...
void CStreamDummyWrite::PutByte(_IN BYTE ucValue)                     { m_uiBytesWritten += sizeof(ucValue);  SCF_UNREFERENCED_PARAMETER(ucValue); }
void CStreamDummyWrite::PutWord(_IN WORD usValue)                     { m_uiBytesWritten += sizeof(usValue);  SCF_UNREFERENCED_PARAMETER(usValue); }
void CStreamDummyWrite::PutInt(_IN int iValue)                             { m_uiBytesWritten += sizeof(iValue);   SCF_UNREFERENCED_PARAMETER(iValue); }
void CStreamDummyWrite::PutInt64(_IN INT64 i64Value)                  { m_uiBytesWritten += sizeof(i64Value); SCF_UNREFERENCED_PARAMETER(i64Value); }
...
void CStreamDummyWrite::PutChar(_IN TCHAR cValue)                     { m_uiBytesWritten += sizeof(cValue);   SCF_UNREFERENCED_PARAMETER(cValue); }
