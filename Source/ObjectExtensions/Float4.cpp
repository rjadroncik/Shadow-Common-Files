...
void CFloat4::Serialize(_INOUT IStreamWrite& rStream) const
{
	rStream.PutBytes(m_Value, sizeof(Float4));
}

void CFloat4::Deserialize(_INOUT IStreamRead& rStream)
{
	rStream.GetBytes(m_Value, sizeof(Float4));
}
