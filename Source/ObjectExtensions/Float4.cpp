...
UINT CFloat4::Parse(_IN CString& rString) { UINT uiCharsParsed = 0; SCFMathematics::CopyVector4(m_Value, Parse(rString, &uiCharsParsed)); return uiCharsParsed; }

Float4& CFloat4::Parse(_IN CString& rString, _OUT _OPT UINT* uipOutCharsParsed)
{
	static Float4 Value;
...
void CFloat4::Parse(_OUT Float4& rOutValue, _IN CString& rString, _OUT _OPT UINT* uipOutCharsParsed)
{
...
CFloat4::CFloat4(_IN CString& rString)                                   { CFloat4::Parse(m_Value, rString, nullptr); }

CFloat4::~CFloat4() {}

CString CFloat4::ToString() _GET { return CFloat4::Print(m_Value); }

float CFloat4::At        (_IN UINT uiIndex)                   _GET { _ASSERTE(uiIndex < 4); return m_Value[uiIndex]; }
float CFloat4::operator[](_IN UINT uiIndex)                   _GET { _ASSERTE(uiIndex < 4); return m_Value[uiIndex]; }
void CFloat4::AtPut      (_IN UINT uiIndex, _IN float fValue) _SET { _ASSERTE(uiIndex < 4); m_Value[uiIndex] = fValue; }